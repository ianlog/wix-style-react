...
import styles from './SortableGridArea.scss';

import defaultDndStyles from 'wix-style-react/dnd-styles';

import { SortableGrid } from '../../index';

const generateId = () => Math.floor(Math.random() * 100000);

export default class SortableGridArea extends React.Component {
    ...
    return (
      <div className={styles.root}>
        ...
        <SortableGrid
          ...
          endFixedElement={<div className={styles.item}>endFixed</div>}
          startFixedElement={<div className={styles.item}>startFixed</div>}
